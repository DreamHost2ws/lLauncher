    ...
    // check update locks
    {
        ...
        if (update_lock.exists()) {
            ...
            auto infoMsg = tr("This installation has a update lock file present at: %1\n"
                              ...
                              "proceeding.\n"
                              "Check the Lighting Launcher updater log at: \n"
                              "%7\n"
        ...
        auto update_fail_marker = QFileInfo(FS::PathCombine(m_dataPath, ".lighting_launcher_update.fail"));
        ...
        auto update_success_marker = QFileInfo(FS::PathCombine(m_dataPath, ".lighting_launcher_update.success"));
